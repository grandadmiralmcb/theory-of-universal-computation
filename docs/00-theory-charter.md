...
| **CP, CC** | Disruption comparison is total (**CP**, ex-AD1) and one-currency/Archimedean (**CC**, ex-AD3). Both proven **independent of O1–O4** (countermodels, docs/20 §§4–5); the RM2 dichotomy shows ¬CC yields a coherent stratified-cost variant — since developed in docs/21, where TS1/TS2 prove the *dynamical floor* must be one-currency and the synthesis candidate **CC′** (exact strata above one Archimedean floor; typing as top stratum via ST1) awaits adoption. AD2 is **derived** (docs/20 §3) and removed from the roster | The two residual bits of the classical quantitative chain (docs/20, docs/21) |
