...
| **CP, CC** | Disruption comparison is total (**CP**, ex-AD1) and one-currency/Archimedean (**CC**, ex-AD3). Both proven **independent of O1–O4** (countermodels, docs/20 §§4–5); the RM2 dichotomy shows ¬CC yields a coherent stratified-cost variant. AD2 is **derived** (docs/20 §3: M1/M2 analytic to O3 + PC from O2/SI + IND from O2/SC) and removed from the roster | The two residual bits of the classical quantitative chain (docs/20) |
